...
<body class="outfit-thin">
    ...
    <div class="w-full">
        ...
        <div class="relative w-full flex items-center justify-center">
            <div class="absolute flex flex-col items-center justify-center -top-8 md:-top-12 shadow-lg inset-x-auto w-auto px-6 py-3 bg-white rounded-lg border border-[#ebebeb]">
            ...
            <div class="bg-[#fafafa] w-5/7 rounded-xl border border-[#d7d7d7] p-2 shadow-2xl">
